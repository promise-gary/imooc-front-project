  ...
  <div>
    ...
    <div class="flex h-[140px]" v-if="themeData.list.length">
      ...
      >
        ...
        />
        <p
          class="absolute bottom-0 left-0 w-full h-[45%] flex items-center backdrop-blur rounded px-1 text-white text-xs duration-300 hover:backdrop-blure-none"
        >
          # {{ themeData.big.title }}
        </p>
      </div>
      <div class="flex flex-wrap flex-1 max-w-[860px]">
        ...
        >
          ...
          />
          <p
            class="absolute top-0 left-0 w-full h-full flex items-center backdrop-blur rounded px-1 duration-300 hover:backdrop-blure-none"
          >
            # {{ item.title }}
          </p>
        </div>
